                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST" id="create_form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="branch_email" class="form-control" placeholder="Enter branch email" />
                                            <span class="text-danger error-text branch_email_error"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Branch Phone Number</label>
                                            <input type="text" name="branch_phone_number" class="form-control" placeholder="Enter branch phone number" />
                                            <span class="text-danger error-text branch_phone_number_error"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Branch Address</label>
                                            <textarea name="branch_address" class="form-control" placeholder="Enter branch address"></textarea>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST" id="edit_form">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Branch Phone Number</label>
                                                    <input type="text" name="branch_phone_number" id="branch_phone_number" class="form-control"  />
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.forceDeleteBtn', function(e){
            ...
            $('.btn-close').trigger('click');
            let id = $(this).attr('id');
            var url = "{{ route('branch.forcedelete', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
                text: "You won't be able to revert this!",
