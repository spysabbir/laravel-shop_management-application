        ...
        <div class="card">
                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST" id="create_form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="customer_address" class="form-control" placeholder="Enter customer Address"></textarea>
                    ...
                    <div class="modal fade" id="trashedModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-primary" id="trashed_customer_table" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Sl No</th>
                                                <th>Name</th>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-light" id="all_customer_table">
                        <thead>
                            <tr>
                                <th>Sl No</th>
                                <th>Join Date</th>
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST" id="edit_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <span class="text-danger error-text update_customer_name_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Customer Email</label>
                                                    <input type="text" name="customer_email" id="customer_email" class="form-control"  />
                                                    <span class="text-danger error-text update_customer_email_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Customer Phone Number</label>
                                                    <input type="text" name="customer_phone_number" id="customer_phone_number" class="form-control"  />
                                                    <span class="text-danger error-text update_customer_phone_number_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Customer Address</label>
                                                    <textarea name="customer_address" id="customer_address" class="form-control" ></textarea>
                                                    <span class="text-danger error-text update_customer_address_error"></span>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.editBtn', function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#customer_phone_number").val(response.customer_phone_number);
        ...
        // Trashed Data
        trashed_table = $('#trashed_customer_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
                url: "{{ route('customer.trashed') }}",
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'customer_name', name: 'customer_name'},
        ...
        $(document).on('click', '.restoreBtn', function(e){
            e.preventDefault();
            let id = $(this).attr('id');
            var url = "{{ route('customer.restore', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                method: 'GET',
        ...
        $(document).on('click', '.forceDeleteBtn', function(e){
            ...
            $('.btn-close').trigger('click');
            let id = $(this).attr('id');
            var url = "{{ route('customer.forcedelete', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
                text: "You won't be able to revert this!",
