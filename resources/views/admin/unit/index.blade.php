        ...
        <div class="card">
                    ...
                    <div class="modal fade" id="trashedModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-primary" id="trashed_unit_table" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Sl No</th>
                                                <th>Unit Name</th>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-light" id="all_unit_table">
                        <thead>
                            <tr>
                                <th>Sl No</th>
                                <th>Unit Name</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST" id="edit_form" enctype="multipart/form-data">
                                                @csrf
                                                @method('PATCH')
                                                <input type="hidden" name="" id="unit_id">
                                                <div class="mb-3">
                                                    <label class="form-label">Unit Name</label>
...
<script>
    $(document).ready(function() {
        ...
        // Read Data
        table = $('#all_unit_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
        ...
        $(document).on('change', '.filter_data', function(e){
            e.preventDefault();
            $('#all_unit_table').DataTable().ajax.reload()
        })
        ...
        // Trashed Data
        trashed_table = $('#trashed_unit_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
                url: "{{ route('unit.trashed') }}",
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'unit_name', name: 'unit_name'},
        ...
        $(document).on('click', '.forceDeleteBtn', function(e){
            ...
            $('.btn-close').trigger('click');
            let id = $(this).attr('id');
            var url = "{{ route('unit.forcedelete', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
                text: "You won't be able to revert this!",
