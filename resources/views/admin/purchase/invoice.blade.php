...
<head>
    ...
    <title>{{ env('APP_NAME') }} || Invoice - {{ $purchase_summary->purchase_invoice_no }}</title>
                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
                        ...
                        <div class="tm_invoice_right tm_text_right tm_mobile_hide">
                            <h3 class="tm_text_uppercase tm_white_color">Invoice No: {{ $purchase_summary->purchase_invoice_no }}</h3>
                        </div>
                        <div class="tm_shape_bg tm_accent_bg tm_mobile_hide"></div>
                    </div>
                    <div class="tm_invoice_info tm_mb25">
                        <div class="tm_card_note tm_mobile_hide"><b class="tm_primary_color">Payment Status: {{ $purchase_summary->payment_status}}</b></div>
                        <div class="tm_invoice_info_list tm_white_color">
                            <p class="tm_invoice_date tm_m0">Date: <b>{{ $purchase_summary->created_at->format('D d,M-Y h:m:s A') }}</b></p>
                        </div>
                    ...
                    <div class="tm_invoice_head tm_mb10">
                        <div class="tm_invoice_left">
                        <p>
                            <strong class="text-inverse">Branch: {{ App\Models\Branch::find($purchase_summary->branch_id)->branch_name }}</strong><br>
                            <strong class="text-inverse">Agent: {{ App\Models\User::find($purchase_summary->purchase_agent_id)->name }}</strong><br>
                        </p>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
                        <p class="tm_mb2"><b class="tm_primary_color">To:</b></p>
                        <p>
                            <strong class="text-inverse">Name: {{ $purchase_summary->relationtosupplier->supplier_name }}</strong><br>
                            Address: {{ $purchase_summary->relationtosupplier->supplier_email }}<br>
                            Phone: {{ $purchase_summary->relationtosupplier->supplier_phone_number }}<br>
                        </p>
                        </div>
                    </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tm_width_4">{{ App\Models\Unit::find($purchase_detail->relationtoproduct->id)->unit_name }}</td>
                                            <td class="tm_width_4">{{ App\Models\Brand::find($purchase_detail->relationtoproduct->id)->brand_name }}</td>
                                ...
                                <table class="tm_mb15">
                                    <tbody>
                                        <tr class="tm_accent_bg">
                                            ...
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">{{ $purchase_summary->sub_total }}</td>
                                        </tr>
                                        <tr class="tm_accent_bg">
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Discount</td>
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color tm_text_right">{{ $purchase_summary->discount }}</td>
                                        </tr>
                                        <tr class="tm_accent_bg">
                                            <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Grand Total</td>
