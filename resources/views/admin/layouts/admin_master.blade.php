...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin') }}/plagins/boxicons/css/boxicons.min.css">
...
<body>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown d-flex">
                                <a class="nav-link d-flex mt-2" href="{{ route('profile.index') }}">
                                    <div class="avatar avatar-online mx-3">
                                        <img src="{{ asset('uploads/profile_photo') }}/{{ Auth::user()->profile_photo }}" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                ...
                                <form method="POST" class="my-4" action="{{ route('logout') }}">
                                @csrf
    ...
    <script src="{{ asset('admin/plagins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
