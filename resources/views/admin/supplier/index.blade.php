        ...
        <div class="card">
                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST" id="create_form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="supplier_phone_number" class="form-control" placeholder="Enter supplier phone number" />
                                            <span class="text-danger error-text supplier_phone_number_error"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Supplier Address</label>
                                            <textarea name="supplier_address" class="form-control" placeholder="Enter supplier address"></textarea>
                    ...
                    <div class="modal fade" id="trashedModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-primary" id="trashed_supplier_table" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Sl No</th>
                                                <th>Supplier Name</th>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-light" id="all_supplier_table">
                        <thead>
                            <tr>
                                <th>Sl No</th>
                                <th>Join Date</th>
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST" id="edit_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <span class="text-danger error-text update_supplier_name_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Supplier Email</label>
                                                    <input type="text" name="supplier_email" id="supplier_email" class="form-control" />
                                                    <span class="text-danger error-text update_supplier_email_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Supplier Phone Number</label>
                                                    <input type="text" name="supplier_phone_number" id="supplier_phone_number" class="form-control"  />
                                                    <span class="text-danger error-text update_supplier_phone_number_error"></span>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Supplier Address</label>
                                                    <textarea name="supplier_address" class="form-control" id="supplier_address"></textarea>
                                                    <span class="text-danger error-text update_supplier_address_error"></span>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        // Read Data
        table = $('#all_supplier_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
            ...
            columns: [
                ...
                {data: 'supplier_phone_number', name: 'supplier_phone_number'},
        ...
        $(document).on('change', '.filter_data', function(e){
            e.preventDefault();
            $('#all_supplier_table').DataTable().ajax.reload()
        })
        ...
        $(document).on('click', '.editBtn', function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#supplier_phone_number").val(response.supplier_phone_number);
        ...
        // Trashed Data
        trashed_table = $('#trashed_supplier_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            ajax: {
                url: "{{ route('supplier.trashed') }}",
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'supplier_name', name: 'supplier_name'},
        ...
        $(document).on('click', '.restoreBtn', function(e){
            e.preventDefault();
            let id = $(this).attr('id');
            var url = "{{ route('supplier.restore', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                method: 'GET',
        ...
        $(document).on('click', '.forceDeleteBtn', function(e){
            ...
            $('.btn-close').trigger('click');
            let id = $(this).attr('id');
            var url = "{{ route('supplier.forcedelete', ":id") }}";
            url = url.replace(':id', id)
            Swal.fire({
                title: 'Are you sure?',
                text: "You won't be able to revert this!",
        ...
        $(document).on('click', '.statusBtn', function(e){
            e.preventDefault();
            let id = $(this).attr('id');
            var url = "{{ route('supplier.status', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                method: 'GET',
